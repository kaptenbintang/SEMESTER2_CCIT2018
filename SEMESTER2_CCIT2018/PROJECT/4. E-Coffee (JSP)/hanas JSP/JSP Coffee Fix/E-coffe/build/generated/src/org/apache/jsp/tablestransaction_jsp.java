...
public final class tablestransaction_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("          <p class=\"mb-4\">This is table coffee transaction</p>\n");
      out.write("\n");
      out.write("          <!-- DataTales Example -->\n");
      out.write("          <div class=\"card shadow mb-4\">\n");
      out.write("            <div class=\"card-header py-3\">\n");
      out.write("              <h6 class=\"m-0 font-weight-bold text-primary\">E-Coffee Transaction</h6>\n");
      out.write("            </div>\n");
      ...
      out.write("                  <thead>\n");
      out.write("                    <tr>\n");
      out.write("                      <th>ID Transaction</th>\n");
      ...
      out.write("                    <tr>\n");
      out.write("                  <td>");
      out.print(data.get(x).getId_transaction());
      out.write("</td>\n");
      out.write("                  <td>");
      ...
      out.write("</td>\n");
      out.write("                  <td>");
      out.print(data.get(x).getTotal_price());
      out.write("</td>\n");
      out.write("                  <td>");
      out.print(data.get(x).getAddress());
      out.write("</td>\n");
      out.write("                  <td>");
      out.print(data.get(x).getDate_of_purchase());
      out.write("</td>\n");
      out.write("                  <td>\n");
      out.write("                      <a href=\"TransactionController?proses=edit-transaction&id_transaction=");
      out.print(data.get(x).getId_transaction());
      out.write("\"><button class=\"btn btn-primary\">Edit</button></a>\n");
      out.write("                      <a href=\"TransactionController?proses=hapus-transaction&id_transaction=");
      out.print(data.get(x).getId_transaction());
