...
public final class editcoffee_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                  </div>\n");
      out.write("                   <form class=\"user\" action=\"CoffeeController?data=coffee&proses=update-coffee\" method=\"post\">\n");
      out.write("                       ");

                  String ket = request.getParameter("id_coffee");
                  CoffeeModel km = new CoffeeModel();
                  km.setId_coffee(ket);
                  List<CoffeeModel> data = new ArrayList<CoffeeModel>();
                  data = km.cariIdCoffee();
                  if (data.size() > 0) {
              
      out.write("\n");
      out.write("              \n");
      out.write("                <div class=\"form-group\">\n");
      out.write("                    <input type=\"hidden\" class=\"form-control\" name=\"id_coffee\" value=\"");
      out.print(data.get(0).getId_coffee());
      out.write("\">\n");
      out.write("                </div>\n");
      out.write("              \n");
      out.write("              <div class=\"form-group\">\n");
      out.write("                  <label for=\"uname\"><b>Coffee Name</b></label>\n");
      out.write("                    <input type=\"text\" class=\"form-control\"  name=\"coffee_name\" placeholder=\"Coffee Name\" value=\"");
      out.print(data.get(0).getCoffee_name());
      out.write("\" required>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"form-group\">\n");
      out.write("                    <label for=\"st\"><b>Stock</b></label>\n");
      out.write("                  <input type=\"text\" class=\"form-control\"  name=\"stock\" placeholder=\"Stock\" value=\"");
      out.print(data.get(0).getStock());
      out.write("\" required>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"form-group\">\n");
      out.write("                    <label for=\"pir\"><b>Price</b></label>\n");
      out.write("                    <input type=\"text\" class=\"form-control\"   name=\"price\" placeholder=\"Price\" value=\"");
      out.print(data.get(0).getPrice());
      out.write("\" required>\n");
      out.write("                </div>\n");
      out.write("        \n");
      out.write("                 <div class=\"form-group\"> \n");
      out.write("                     <label for=\"exp\"><b>Expired</b></label>\n");
      out.write("                     <input type=\"date\" class=\"form-control\" name=\"expired\" placeholder=\"Expired\" value=\"");
      out.print(data.get(0).getExpired());
      out.write("\" required>\n");
      out.write("                </div>\n");
      out.write("                <button type=\"submit\" class=\"btn btn-primary btn-user btn-block\" value=\"Update\" >Update</button>\n");
      out.write("                ");
}
      out.write("\n");
      out.write("                <hr>\n");
