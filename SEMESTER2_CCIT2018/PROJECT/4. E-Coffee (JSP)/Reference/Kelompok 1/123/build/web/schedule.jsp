<%-- 
    Document   : event
    Created on : Jul 1, 2019, 8:30:50 PM
    Author     : Anugrah
--%>
...
p {
  ...
  <form class="modal-content animate" action="ScheduleController?data=user&proses=input-user" method="post">
    ...
    <div class="imgcontainer">
      ...
      <input type="date" placeholder="Enter Username" name="date_evt" required>
      <br>
      <label for="psw"><b>Event:</b></label>
      <input type="text" placeholder="Enter Division" name="event" required>
      <br>
      <label for="psw"><b>Vote   :</b></label>
    ...
    <th style="width:60%;">Location</th>
     <th style="width:40%;">Action</th>
              ...
              %>
               <tr>
                  <td><%=x + 1%></td>
                  <td><%=data.get(x).getDate_evt()%></td>
                  <td><%=data.get(x).getEvent()%></td>
                  <td><%=data.get(x).getLocation()%></td>
                  <td>
      <a href="ScheduleController?proses=edit-user&schedule_id=<%=data.get(x).getSchedule_id()%>" data-toggle="modal"  class='li-modal'><button>Update</button></a>
              
      <a href="ScheduleController?proses=hapus-user&schedule_id=<%=data.get(x).getSchedule_id()%>"><button>Hapus</button></a>
                  </td>
              </tr>
              <%}%>
          </table>
