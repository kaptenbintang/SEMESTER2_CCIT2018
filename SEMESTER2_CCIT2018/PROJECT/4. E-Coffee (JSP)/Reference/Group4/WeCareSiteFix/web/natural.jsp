<%-- 
    Document   : natural
    Created on : Jun 30, 2019, 8:25:44 PM
    Author     : Haidar
--%>
...
<div id="border1" >
  <a href="longsor.jsp"><img src="images/longsor.png" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b>Landslide Disaster</b></h5>
        <h5 style="font-size:18px; color:#000000; margin-left:15px; margin-bottom:10px">It's been almost a week, ...</h5>
    </div>
</div>

<div id="border2" >
  <a href="banjir.jsp"><img src="images/banjir.png" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b>Samarinda Flood</b></h5>
        <h5 style="font-size:18px; color:#000000; margin-left:15px; margin-bottom:10px">Some areas in East Kalimantan ...</h5>
        
    </div>

<div id="border3" >
  <a href="tsunami.jsp"><img src="images/tsunami.jpg" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b>Aceh Tsunami</b></h5>
        <h5 style="font-size:18px; color:#000000; margin-left:15px; margin-bottom:10px">Indonesia still have a major ...</h5>
        
    </div>
    <br><br><br><br><br><br><br><br><br><br><br><br><br><br>
    <div id="border1" >
  <a href="tsunami1.jsp"><img src="images/tsunami1.png" alt="Natural Disaster" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b>Banten Tsunami</b></h5>
        <h5 style="font-size:18px; color:#000000; margin-left:15px; margin-bottom:10px">Sunday night December 22, 2018, ...</h5>
        
    </div>
<div id="border2" >
  <a href="lombok.jsp"><img src="images/lombok.jpg" alt = "Natural Disaster" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b>Lombok Earthquake</b></h5>
        <h5 style="font-size:18px; color:#000000; margin-left:15px; margin-bottom:10px">Sunday (3/17) yesterday, an earthquake ...</h5>
        
    </div>
  
<div id="border3" >
  <a href="jakarta.jsp"><img src="images/jakarta.jpg" alt = "Natural Disaster" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b>Jakarta Flood</b></h5>
        <h5 style="font-size:18px; color:#000000; margin-left:15px; margin-bottom:10px">Since 6.30 WIB on Friday (4/26/2019)...</h5>
