<%-- 
    Document   : masjid
    Created on : Jun 30, 2019, 8:24:27 PM
    Author     : Haidar
--%>
...
<br>
              <%
                  ...
                  for (int x = 0; x < data8.size(); x++) {
              %>
<h1><center id="title" style=""><%=data8.get(x).getJudul()%></center></h1>
<br>
<center><img src="images/foto12.jpg" height="auto" width="40%" style=""></center>
<br>
<br>
 <div class="container">
    <div class="row">
      <div class="" style=" margin-left:5%; color:#130f40;">
        <article style="font-size:20px"><%=data8.get(x).getDeskripsi()%>
        </article>
    </div>
  </div>
  </div>
