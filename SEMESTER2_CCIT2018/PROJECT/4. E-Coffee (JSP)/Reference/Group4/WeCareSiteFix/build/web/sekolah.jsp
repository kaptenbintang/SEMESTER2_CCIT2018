<%-- 
    Document   : sekolah
    Created on : Jun 30, 2019, 8:27:29 PM
    Author     : Haidar
--%>
...
<br>
                <%
                  ...
                  for (int x = 0; x < data7.size(); x++) {
              %>
<h1><center id="title"><%=data7.get(x).getJudul()%></center></h1>
<br>
<center><img src="images/foto4.jpg" height="auto" width="30%" style=""></center>
<br>
<br>
 <div class="container">
    <div class="row">
      <div class="" style=" margin-left:5%; color:#130f40;">
          <article style="font-size:20px"><%=data7.get(x).getDeskripsi()%></article>
      </div>
    </div>
  </div>
  </div>
