<%-- 
    Document   : water
    Created on : Jun 30, 2019, 8:30:51 PM
    Author     : Haidar
--%>
...
<%
              ...
              %>
<h1><center id="title" style=""><%=data2.get(x).getJudul()%></center></h1>
<br>
<center><img src="images/foto1.jpg" height="auto" width="35%" style=""></center>
<br>
<br>
 <div class="container">
    <div class="row">
      <div class="" style=" margin-left:5%; color:#130f40;">
        <article style="font-size:20px"> <%=data2.get(x).getDeskripsi()%>
 </article>
        </div>
    </div>
  </div>
