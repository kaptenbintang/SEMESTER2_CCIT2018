<%-- 
    Document   : kids
    Created on : Jun 30, 2019, 8:22:10 PM
    Author     : Haidar
--%>
...
<%
              ...
              %>
<h1><center id="title" style="margin-left: "><%=data4.get(x).getJudul()%></center></h1>
<br>
<center><img src="images/foto2.jpg" height="auto" width="35%" style=""></center>
<br>
<br>
 <div class="container">
    <div class="row">
      <div class="" style=" margin-left:2%; color:#130f40;">
        <article style="font-size:22px"> <%=data4.get(x).getDeskripsi()%> </article>
        </div>
    </div>
  </div>
  </div>
