<%-- 
    Document   : hospital
    Created on : Jun 30, 2019, 8:20:45 PM
    Author     : Haidar
--%>
...
<br>
<br>
<h1><center id="title">Indonesian Hospital Palestine</center></h1>
<br>
<center><img src="images/foto18.jpg" height="auto" width="40%" style=""></center>
<br>
<br>
 <div class="container">
    <div class="row">
      <div class="" style=" margin-left:5%; color:#130f40;">
        <article style="font-size:20px">Thousands of Palestinians need medical assistance in the form of medicines and health facilities. The damage to most health facilities due to humanitarian disasters has resulted in the increasing need for adequate health services.<br><br>In the humanitarian mission built between BAZNAS, the Indonesian Ulema Council and several amil zakat institutions in Indonesia, and for the support of the Indonesian people, God willing, we will jointly build an Indonesian Hospital in Hebron (RSIH), Palestine.</article>
        </div>
    </div>
  </div>
  </div>
  <br>
  <center><img src="images/foto19.jpg" height="auto" width="30%" style=""></center>
  <br>
 <div class="container">
    <div class="row">
      <div class="" style=" margin-left:5%; color:#130f40;">
        <article style="font-size:20px">The city of Hebron is located in the West Bank, Palestine and is about 30 KM on the south side of Jerusalem. There is the Prophet Ibrahim Mosque which is still a place of worship for Muslims in Palestine. The location of the land to be built RSIH is about 1 KM from the location of the Prophet Ibrahim Mosque.</article>
        </div>
    </div>
  </div>
  </div>
  <br>
  <center><img src="images/foto20.jpg" height="auto" width="30%" style=""></center>
  <br>
  <div class="container">
    <div class="row">
      <div class="" style=" margin-left:5%; color:#130f40;">
        <article style="font-size:20px">The RSIH development fund costs around USD 6,745,000 or 97 billion rupiah. These costs include the cost of construction, purchase of equipment and initial operations of the hospital. Services provided include the ER, general and specialist polyclinics, ICU, operating room, boardroom, and pharmacy.<br><br>Let's help our brothers and sisters in Palestine by building an Indonesian Hospital in Hebron by donating.</article>
        </div>
    </div>
  </div>
  </div>
