<%-- 
    Document   : church
    Created on : Jun 30, 2019, 8:19:45 PM
    Author     : Haidar
--%>
...
<br>
              ...
              %>
<h1><center id="title"><%=data9.get(x).getJudul()%></center></h1>
<br>
<center><img src="images/foto14.jpg" height="auto" width="30%" style=""></center>
<br>
<br>
 <div class="container">
    <div class="row">
      <div class="" style=" margin-left:5%; color:#130f40;">
        <article style="font-size:20px"><%=data9.get(x).getDeskripsi()%></article>
        </div>
    </div>
  </div>
  </div>
