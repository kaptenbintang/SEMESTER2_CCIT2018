<%-- 
    Document   : sosial
    Created on : Jun 30, 2019, 8:28:45 PM
    Author     : Haidar
--%>
...
<div id="border1" >
  <a href="palestine.jsp"><img src="images/foto.jpg" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b>The hungry Palestine kids</b></h5>
        <h5 style="font-size:18px; color:#000000; margin-left:15px; margin-bottom:10px">They are not happy there as ...</h5>
        
    </div>
</div>

<div id="border2" >
  <a href="water.jsp"><img src="images/foto1.jpg" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b>Minim water in town</b></h5>
        <h5 style="font-size:18px; color:#000000; margin-left:15px; margin-bottom:10px">Water is the source ...</h5>
        
    </div>

<div id="border3" >
  <a href="kids.jsp"><img src="images/foto2.jpg" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b>Kids without parents</b></h5>
        <h5 style="font-size:18px; color:#000000; margin-left:15px; margin-bottom:10px">Parents are a source of happines ...</h5>
        
    </div>
    <br><br><br><br><br><br><br><br><br><br><br><br><br><br>  
    <div id="border1" >
  <a href="palestine.jsp"><img src="images/foto3.jpg" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b>Children of war victim</b></h5>
        <h5 style="font-size:18px; color:#000000; margin-left:15px; margin-bottom:10px">They are not happy there as ...</h5>
        
    </div>
<div id="border2" >
  <a href="sakit.jsp"><img src="images/foto9.jpg" alt="Sosial Service" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b>Medicine Needs</b></h5>
        <h5 style="font-size:18px; color:#000000; margin-left:15px; margin-bottom:10px">Children need Medicine ...</h5>
        
    </div>
  
<div id="border3" >
  <a href="lapar.jsp"><img src="images/lapar.png" alt="Sosial Service" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b>Somalia Starvation</b></h5>
        <h5 style="font-size:18px; color:#000000; margin-left:15px; margin-bottom:10px">Hunger caused by the  ...</h5>
