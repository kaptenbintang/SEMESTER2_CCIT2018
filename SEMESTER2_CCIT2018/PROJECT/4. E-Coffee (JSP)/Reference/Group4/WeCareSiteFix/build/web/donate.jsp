<%-- 
    Document   : donate
    Created on : Jun 30, 2019, 8:00:10 PM
    Author     : Haidar
--%>
...
<div id="border1" >
  <a href="palestine.jsp"><img src="images/foto.jpg" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b><%=data.get(0).getJudul()%></b></h5>
...
<div id="border2" >
  <a href="water.jsp"><img src="images/foto1.jpg" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b><%=data1.get(0).getJudul()%></b></h5>
...
<div id="border3" >
  <a href="tsunami.jsp"><img src="images/tsunami.jpg" height="auto" width="100%">
        ...
        <h5 style="font-size:18px; color:#000000; margin-left:15px; margin-bottom:10px">The tsunami that hit Aceh ...</h5>
        
    </div>
    <br><br><br><br><br><br><br><br><br><br><br><br><br><br>  
    <div id="border1" >
  <a href="victim.jsp"><img src="images/foto3.jpg" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b>Children of war victim</b></h5>
        <h5 style="font-size:18px; color:#000000; margin-left:15px; margin-bottom:10px">They are not happy there as ...</h5>
        
    </div>
<div id="border2" >
  <a href="sekolah.jsp"><img src="images/foto4.jpg" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b>Unilala Elementary School</b></h5>
        <h5 style="font-size:18px; color:#000000; margin-left:15px; margin-bottom:10px">One of the very common ...</h5>
        
    </div>
  
<div id="border3" >
  <a href="masjid.jsp"><img src="images/foto12.jpg" height="auto" width="100%">
        <h5 style="font-size:22px; color:#130f40; margin-left:15px; line-height:30px;"><b>Village Masjid Need Help</b></h5>
        <h5 style="font-size:18px; color:#000000; margin-left:15px; margin-bottom:10px">The man was seen crying ...</h5>
