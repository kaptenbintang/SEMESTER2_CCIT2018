<%-- 
    Document   : banjir
    Created on : Jun 30, 2019, 8:17:12 PM
    Author     : Haidar
--%>
...
<%
                  ...
                  for (int x = 0; x < data6.size(); x++) {
              %>
<h1><center id="title"><%=data6.get(x).getJudul()%></center></h1>
<br>
<center><img src="images/banjir.png" height="auto" width="30%" style=""></center>
<br>
<br>
 <div class="container">
    <div class="row">
      <div class="" style=" margin-left:5%; color:#130f40;">
        <article style="font-size:20px"><%=data6.get(x).getDeskripsi()%>
        </article>
      </div>
    </div>
  </div>
